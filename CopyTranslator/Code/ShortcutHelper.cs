...
namespace CopyTranslator.Code
{
    public class ShortcutHelper
    {
        ...
        {
            AppId = appid;
            String shortcutPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + "\\Microsoft\\Windows\\Start Menu\\Programs\\CopyTranslator.lnk";
